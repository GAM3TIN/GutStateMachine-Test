...
import frc.robot.Gut.ColorSensor.CloseColorSensorStates;

import java.lang.Math;

public class GutStateMachine extends SubsystemBase {
...
if(colorSensor.getColorFar() == correctColor() && colorSensor.getColorClose() == CloseColorSensorStates.NONE){ //intake no cargo
...
if(colorSensor.getColorFar() == correctColor() && colorSensor.getColorClose() == CloseColorSensorStates.NONE){
